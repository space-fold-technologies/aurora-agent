...
func (x *AgentDetails) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *AgentDetails) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
var file_agents_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x22, 0x38, 0x0a, 0x0c, 0x41, 0x67, 0x65, 0x6e, 0x74, 0x44, 0x65, 0x74, 0x61, 0x69,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x42, 0x0a, 0x5a, 0x08,
	0x2e, 0x3b, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_agents_proto_goTypes = []interface{}{
	...
	(*AgentDetails)(nil),  // 2: AgentDetails
}
